...
const (
	...
	PromptCacheUnknown PromptCacheStatus = "unknown"
)

func DerivePromptCacheStatus(cacheReadTokens *int) PromptCacheStatus {
	if cacheReadTokens == nil {
		return PromptCacheUnknown
	}
	if *cacheReadTokens > 0 {
		return PromptCacheHit
	}
	return PromptCacheMiss
}
...
type MeteringRecord struct {
	...
	PromptCacheStatus       PromptCacheStatus `json:"prompt_cache_status"`
